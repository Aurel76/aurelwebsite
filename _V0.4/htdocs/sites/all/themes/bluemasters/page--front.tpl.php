        ...
        <div class="container_12">
            ...
            <div class="grid_12">
                ...
                <div id="home-blocks-area" class="clearfix">
                    <!-- Ma page d'accueil avec mon texte et ma video du moment -->
                    <div align="center">
                        <h2>
                        ...
                        <br>
                        <p>
                            Ce site te permet d'écouter de la musique, la radio, de jouer, d'apprendre des news, ... bref de passer du bon temps !<br>
                            @urelwebsite a été entièrement pensé, conçu et codé par l'administrateur <i>@urel$76</i><br>
                            C'est le 1<sup>er</sup> site personnel de <i>@urel$76</i>, qui a été motivé pour le mettre en place grâce à l'entreprise <a href="http://www.makemeweb.net" target="_blank" title="Site internet de MakeMeWeb"><font color="#00BFFF">MakeMeWeb</font></a><br>
                            So enjoy and don't forget "YOU ARE AWESOME !"
                        </p>
                        <br>
                        <p>
                        ...
                        <p>
                            <iframe width="560" height="315" src="http://www.youtube.com/embed/rMltoD1jCGI" frameborder="0" allowfullscreen></iframe>
                        </p>
                        <br>
                    </div>
            		<?php if ($messages): ?>
